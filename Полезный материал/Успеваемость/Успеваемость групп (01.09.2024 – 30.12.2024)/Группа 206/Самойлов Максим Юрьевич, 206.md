...
| Тема                                                                           | Изучение лекции | Дата     | Синопсис к лекции |                 Практика                 | Дата     |
| ------------------------------------------------------------------------------ | :-------------: | -------- | :---------------: | :--------------------------------------: | -------- |
| [[Что такое база данных. Типы баз данных]]                                     |        +        | 15.10.24 |                   | [[Задание. Начало работы с SQL Academy]] | 06.11.24 |
...
| Тема                      |          Сдача           |   Дата   |
| ------------------------- | :----------------------: | :------: |
| [[Задание. Угадай число]] | 24.09.24. `+3` балла(ов) | 24.09.24 |
...
Дата использования: `2024-11-11, 11:15`
