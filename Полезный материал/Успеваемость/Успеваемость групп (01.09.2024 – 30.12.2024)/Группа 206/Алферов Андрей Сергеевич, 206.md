...
tags:
  - Информация
Ссылка_на_источник: '"Полезный материал/Успеваемость/Успеваемость групп (01.09.2024 – 30.12.2024)/Успеваемость группы 206"'
Пройдено_тем_алг: "18"
...
| Тема                                                                                                                                 |         Сдача          |   Дата   |
| ------------------------------------------------------------------------------------------------------------------------------------ | :--------------------: | :------: |
| Наследован 10.09.24. Выполнил задание в лекции наследования. Условие задания было не полным, но проявил инициативу и исправил ошибку | 10.09.24 `+2` балл(ов) | 10.09.24 |
| Самостоятельный проект «Игра Тетрис» ([[tetris.py\|файл]])                                                                           | 22.11.24 `+4` балл(ов) | 22.11.24 |
| Самостоятельный проект «Игра Змейка» ([[snake.py\|файл]])                                                                            | 22.11.24 `+5` балл(ов) | 22.11.24 |
| Самостоятельный проект «Игра Аркада» ([[arkada.py\|файл]])                                                                           | 22.11.24 `+4` балл(ов) | 22.11.24 |
| Самостоятельный проект «Игра Минное поле» ([[iraq.py\|файл]])                                                                        | 22.11.24 `+5` балл(ов) | 22.11.24 |
