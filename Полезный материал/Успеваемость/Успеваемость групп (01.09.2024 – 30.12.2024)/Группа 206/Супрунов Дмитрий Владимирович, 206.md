...
| [[Замыкание]]                                                   |        +        | 08.10.24 |                   |                                                                  |          |
| [[Декораторы]]                                                  |        +        | 14.10.24 |                   |                                                                  |          |
| [[Объектно-ориентированное программирование. Классы и объекты]] |        +        | 17.10.24 |                   |                  [[Задание. Классы и объекты]]                   | 21.10.24 |
...
| Тема                                                                           | Изучение лекции | Дата     | Синопсис к лекции |                 Практика                 | Дата     |
| ------------------------------------------------------------------------------ | :-------------: | -------- | :---------------: | :--------------------------------------: | -------- |
| [[Что такое база данных. Типы баз данных]]                                     |        +        | 15.10.24 |                   | [[Задание. Начало работы с SQL Academy]] | 21.11.24 |
| [[Терминология и базовые принципы БД. Система управления базой данных (СУБД)]] |        +        | 11.11.24 |                   |   [[Задание. Модуль 1 в SQL Academy]]    | 21.11.24 |
...
| Тема                                                                                                    |        Сдача         |   Дата   |
| ------------------------------------------------------------------------------------------------------- | :------------------: | :------: |
| Танки ([[проект танки Супрунов Дмитрий 206 v2.py\|файл]])                                               | 12.11.24 `+5` баллов | 14.11.24 |
| Программа для демонстрации основных концепций программирования ([[ппц Супрунов Дмитрий 206г.py\|файл]]) | 25.11.24 `+5` баллов | 25.11.24 |
...
| -------------------------------------------------- | :------------: | :--------------------: | :------: |
| Условная конструкция if на примере проекта «Танки» |    26.11.24    | 28.11.24 `+5` балл(ов) | 28.11.24 |
