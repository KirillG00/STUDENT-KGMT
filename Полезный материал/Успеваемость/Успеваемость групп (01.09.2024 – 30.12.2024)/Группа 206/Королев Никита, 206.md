...
| --------------------------------------- | :------------: | :----------------: | :------: |
| Нейросети. Внедрение в рабочие процессы |    06.12.24    |    `+5` баллов     | 09.12.24 |
...
- Дополнительно занимается после пар `+10` баллов
- Невозможность заниматься дома `+15` баллов
- Отсутствие по болезни `+15` баллов
