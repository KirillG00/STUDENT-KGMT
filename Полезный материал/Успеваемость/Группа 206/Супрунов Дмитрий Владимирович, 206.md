...
| Тема                                                           |        Сдача         |   Дата   |
| -------------------------------------------------------------- | :------------------: | :------: |
| Танки                                                          | 12.11.24 `+3` баллов | 14.11.24 |
| Программа для демонстрации основных концепций программирования | 25.11.24 `+3` баллов | 25.11.24 |
...
| -------------------------------------------------- | :------------: | :----------------: | :------: |
| Условная конструкция if на примере проекта «Танки» |    26.11.24    |                    | 28.11.24 |
|                                                    |                |                    |          |
|                                                    |                |                    |          |
|                                                    |                |                    |          |
|                                                    |                |                    |          |
