...
| Тема                                                                                                                                              |  Сдача   |   Дата   |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | :------: | :------: |
| Наследован 10.09.24. Выполнил задание в лекции наследования. Условие задания было не полным, но проявил инициативу и исправил ошибку. `+2 баллов` | 10.09.24 | 10.09.24 |
| Самостоятельный проект «Игра Тетрис». `+3 баллов`                                                                                                 | 22.11.24 | 22.11.24 |
| Самостоятельный проект «Игра Змейка». `+3 баллов`                                                                                                 | 22.11.24 | 22.11.24 |
| Самостоятельный проект «Игра Аркада». `+3 баллов`                                                                                                 | 22.11.24 | 22.11.24 |
| Самостоятельный проект «Игра Минное поле». `+3 баллов`                                                                                            | 22.11.24 | 22.11.24 |
...
| ------------------------------- | :------------: | :----------------: | :------: |
| Программирование в военном деле |    30.11.24    |    `+5` баллов     | 26.11.24 |
