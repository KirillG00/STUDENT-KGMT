...
#### Добавлены
- **Система порядочности**. Узнайте свои ограничения и привилегии в изучении IT специальностей. Функция находится в разработке. Подробности вы можете узнать в [[Мануал по использованию STUDENT#Установка базы данных|мануале]].
