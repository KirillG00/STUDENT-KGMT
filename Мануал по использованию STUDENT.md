...
Перечень всех привилегий и ограничений представлен в этом [[Перечень ограничений и привилегий|файле]].

Балл порядочности высчитывается по следующей формуле: `(((изученные_лекции + выполненные_практики) / (всего_лекций + всего_практики) * 100) + (поведение / 10)) * (0.75 + (0.05 * синопсисы)) + баллы_уважительной_причины`
