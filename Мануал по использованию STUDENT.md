...
#### Преобразование очков порядочности в оценки 

Для  понимания как преобразовываются очки порядочности в общей системе оценивания, вам предоставляется следующая таблица:
