...
> **STUDENT** — это платформа для помощи в изучении информационных технологий, созданная для обеспечения комфортного и доступного образовательного процесса студентов. Доступ к базе данных является **бесплатным** и открытым.
...
База данных создана для **структурированного изучения области информационных технологий**.

Здесь вы сможете _изучать лекции, выполнять практические задания, находить полезные ссылки на интернет-ресурсы и многое другое_. Полный список возможностей представлен в отдельной главе [[Мануал по использованию STUDENT#Функционал STUDENT|Функционал]].

---
## Что можно найти в STUDENT?

- **Лекции**. Теоретический материал, разделенный по предметам и курсам. В каждой лекции представлены полезные ссылки, практический материал, а также иногда видео-материалы.
...
**Важно**: так как материал постоянно обновляется и изменяется, редактирование уже существующих материалов студентом не рекомендуется. Если у вас есть предложения по улучшению материалов, обратитесь к преподавателю или непосредственно к создателю.
...
- Для **поиска по ключевым словам** откройте панель инструментов (в левом верхнем углу) и воспользуйтесь вкладкой «Поиск».
...
- **Отсылайте домашние задания на источник, который укажет ваш преподаватель.** Это может быть его почта или [[Мануал по использованию STUDENT#Интерактивная среда|Интерактивная среда]] STUDENT
...
- **Расписание**. Ближайшие пары с лекцией, практическими заданиями и списком дежурств. Оформляется преподавателем на неопределенный срок. В личной версии заменена на «Мое расписание»;
- **Успеваемость**. Прогресс в изучении темы, выполнении практического задания и т.д, разделенный по группам и каждому студенту. В личной версии заменена на «Моя успеваемость»;
...
![[Pasted image 20240926112528.png|300]]

 *В личной версии подпапки отсутствуют и заменены на файл «Успеваемость»*

Бланки состоят из следующих разделов:

1. **Общая информация о студенте**. ФИО и дата рождения. Такая информация как адрес, номер телефона и другие, не должны фигурировать в базе данных в принципе.
...
*В личной версии вы не ограниченны в использовании интерактивной среды, кроме совместного использования с другими пользователями, по понятным причинам*
...
Под ежедневными действиями подразумеваются некоторые манипуляции, для поддержания чистоты ведения записей и избежание конфликтных ситуаций с контролем версии.
...
1. **Интерактивная среда доступна для редактирования студентом**. Это единственная область, к которой есть доступ как у студента, так и у преподавателя. Вы можете обеспечить доступ к ней студентов через локальную сеть с определенными правами доступа.
